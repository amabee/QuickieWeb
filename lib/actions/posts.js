...
export const getComments = async (postID, user_id) => {
  try {
    const res = await axios.get(POSTS_ENDPOINT, {
      params: {
    ...
    if (res.data.success) {
      ...
      return {
        ...
        message:
          ...
          "Something went wrong sending the reply.",
        data: null,
      };
    }
  } catch (e) {
...
export const likeCommentReply = async ({ formData }) => {
  try {
    const res = await axios({
      url: POSTS_ENDPOINT,
      method: "POST",
...
export const unlikeCommentReply = async ({ formData }) => {
  try {
    const res = await axios({
      url: POSTS_ENDPOINT,
      method: "POST",
