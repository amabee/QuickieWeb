...
import Comment from "../forms/Comments";
import { Input } from "../ui/input";
import { formatDateString } from "@/lib/utils";
import CommentCard from "./CommentCard";
import { getComments } from "@/lib/actions/posts";

const ThreadModal = ({ post, user, isOpen, onClose }) => {
      ...
      <DialogContent className="sm:max-w-[95vw] sm:max-h-[95vh] h-screen w-screen p-0 overflow-hidden">
        <div className="flex h-full bg-black text-white">
          ...
          <div className="w-[40%] flex flex-col bg-gray-900 border-l border-gray-800">
            ...
            {/* Comments section */}
            <div className="flex-grow overflow-y-auto p-4 divide-y-2">
              {/* Caption */}
              <div className="mb-4">
                {/* <CommentCard
                  author={post.author}
                  ...
                  authorImage={user_image_path + post.creator_image}
                /> */}
              ...
              {comments.length > 0 ? (
                ...
                <p>No comments yet</p> // Render a message or some placeholder when no comments exist
              )}
            </div>
            ...
            <div className="p-4 border-t border-gray-800">
              <div className="relative">
                ...
                <Button
                  size="icon"
                  className="absolute right-1 top-1/2 transform 
               -translate-y-1/2 bg-transparent rounded-md hover:bg-transparent"
                >
